...
public class Rotation : ICommand
{
    ...
    {
        int direction = (int)Char.GetNumericValue(work[1].ToCharArray()[0]);
        Orientations orient;

        if (direction == 1)
        {
            orient = Orientations.DEGREES_CW_90;
        }
        else if (direction == 2)
        {
            orient = Orientations.DEGREES_CW_180;
        }
        else if (direction == 3)
        {
            orient = Orientations.DEGREES_CW_270;
        }
        else
        {
            orient = Orientations.DEGREES_CW_0;
        }
